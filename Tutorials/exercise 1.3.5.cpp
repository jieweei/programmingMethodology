...
{ //it is a symbol use to defines the scope of the code like all statement within the main() function.
    ...
    cout << 25 //this statement starts the output operation and displays the number 25.
         << 83 //this continues the same output statement and displays the number 83.
         << 250 //this side also same output statement and it also displays the number 250.
         << (25 * 83 * 250) << endl; //this side is let the system to calculates the expression 25*83*250 first, then it will displays the result.
